    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
         ...
         <div className='w-full'>
          ...
          <textarea onChange={(e)=>setAuthor(e.target.value)} value={author} className='w-full max-w-[500px] px-3 ' type="text" placeholder='author name' required/>
        </div>

        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>

            <div>
              <p className='mb-2'>Book Language</p>
